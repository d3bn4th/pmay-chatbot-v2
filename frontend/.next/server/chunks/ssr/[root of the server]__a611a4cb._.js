...
function DocumentUpload({ onUpload, t }) {
    ...
    const handleFile = async (file)=>{
        ...
        try {
            ...
            const response = await fetch(`/api/upload?language=${language}`, {
                method: "POST",
                body: formData
            });
        ...
        },
        {
            ...
            links: [
                ...
                },
                {
                    ...
                    label: t('find_nearest_office'),
                    href: "https://pmaymis.gov.in/",
                    description: t('locate_pmay_offices'),
                    external: true
                }
            ]
        },
...
const translations = {
    ...
    hi: {
        ...
        sample_question_2: "PMAY में आवेदन कैसे करें?",
        sample_question_3: "PMAY (Urban) क्या है और इसके उद्देश्य क्या हैं?",
        sample_question_4: "In-Situ Slum Redevelopment (ISSR) क्या है?",
        sample_question_5: "CLSS (क्रेडिट लिंक्ड सब्सिडी स्कीम) क्या है?",
        sample_question_6: "क्रेडिट लिंक्ड सब्सिडी योजना (सीएलएसएस) क्या है?",
        sample_question_7: "साझेदारी में किफायती आवास (एएचपी) क्या है?",
        sample_question_8: " लाभार्थी के नेतृत्व में व्यक्तिगत घर निर्माण संवर्द्धन (बीएलसी) क्या है?",
        sample_question_9: "प्रधानमंत्री आवास योजना (शहरी) योजना के तहत लाभार्थी के रूप में किसे परिभाषित किया गया है?"
    }
};
}}),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a611a4cb._.js.map